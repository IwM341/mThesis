...
\begin{figure}[!h]
	\begin{center}
		\begin{tikzpicture}[scale = 0.9]
			...
			\end{groupplot}
		\end{tikzpicture}
		\caption{Отношение аннигиляции к захвату слева $m_{\chi} = 100 \, \text{ГэВ}$, справа ---  $m_{\chi} = 1000 \, \text{ГэВ}$}
		\label{plot:A_C}
	\end{center}	
\end{figure}
...
\begin{figure}[!h]
	\begin{center}
		\begin{tikzpicture}
			...
			\end{axis}
		\end{tikzpicture}		
		\caption{Ограничения на сечение рассеяния с протоном $\sigma_{\chi p} $ при $m_{\chi} = 100 \, \text{ГэВ}$}
